        ...
        <el-card>
            <template #header>
                <div class = "card-header" style="margin-bottom:0px;">
                    <span class="image-font">长租申请</span>
        ...
        <div class="margin-top" style="width:80%;">
            ...
            <el-form :model="form" label-width="120px">
                ...
                <el-form-item label="租房时间">
                    <el-col :span="11">
                        <el-date-picker v-model="form.date1" type="month" placeholder="起始时间"  style="width: 100%"/>
                    </el-col>
                    <el-col :span="2" class="text-center">
                        <span class="text-gray-500">-</span>
                    </el-col>
                    <el-col :span="11">
                        <el-date-picker v-model="form.date2" type="month" placeholder="结束时间"  style="width: 100%"/>
                    </el-col>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button type="primary" @click="seeContract">查看合同</el-button>
